...
{
	while (!I::Engine->IsInGame()) Sleep(100);
	//to do silent Aim
...
{
	while (global::g_hGameWnd != FindWindowA(XorString("Respawn001"), NULL)) global::g_hGameWnd = FindWindowA(XorString("Respawn001"), NULL);
