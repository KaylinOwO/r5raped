...
void MainWindows()
{
	...
	if (Vars.Menu.Opened)
	{
		...
		if (ImGui::Begin(XorString("r5raped"), &Vars.Menu.Opened, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar))
		{
			const char* tabs[] = {
				"Aim",
				"Visual",
...
//		return true;
	...
	if (GetAsyncKeyState(VK_F11) & 1) Vars.Menu.Opened = !Vars.Menu.Opened;
